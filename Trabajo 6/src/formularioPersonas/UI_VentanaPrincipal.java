...
public class UI_VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnl_barra.setBackground(new java.awt.Color(0, 0, 0));
        ...
        background.add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 240, 150, 20));
        ...
        background.add(txt_apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 280, 150, 20));
        ...
        background.add(txt_cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 320, 150, 20));

        lbl_nombres.setFont(new java.awt.Font("Roboto Light", 1, 12)); // NOI18N
        lbl_nombres.setForeground(new java.awt.Color(0, 0, 0));
        lbl_nombres.setText("Nombres:");
        background.add(lbl_nombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 240, 60, 20));
        ...
        background.add(lbl_apellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 280, 70, 20));
        ...
        background.add(lbl_cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 320, 70, 20));
        background.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 197, 550, -1));
        ...
        background.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 40, 420, 170));
        ...
        background.add(BtnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 350, 90, 30));
        ...
        background.add(BtnLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 350, 90, 30));
        ...
        background.add(BtnModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, 90, 30));
        ...
        background.add(BtnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 90, 30));
        ...
        background.add(txt_nombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, 100, 20));

        lbl_nombres1.setFont(new java.awt.Font("Roboto Light", 1, 12)); // NOI18N
        lbl_nombres1.setForeground(new java.awt.Color(0, 0, 0));
        lbl_nombres1.setText("cedula");
        background.add(lbl_nombres1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 340, 40, 20));
        ...
        background.add(BtnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 330, 90, 30));
